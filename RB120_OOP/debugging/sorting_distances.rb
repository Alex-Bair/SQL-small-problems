...
The Array#sort method uses the #<=> method to sort the elements in an array. The custom Length class does not implement a #<=> method, so the Array#sort call will fail.

We can resolve this by implementing a Length#<=> method.

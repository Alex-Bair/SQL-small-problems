...
To resolve the issue, the @serial_number getter method needed to be a protected method instead of a private method.
This allows other Employee objects to check each others' @serial_number values in the Employee#== method without exposing the @serial_number instance variable to the public interface.

...
function median(nums) {
  // nums.sort(); // by defaul, Array.prototype.sort() sorts based off the string representation of the array's elements. But here, we want to sort based off the numeric value of the elements.
  nums.sort((g1, g2) => g1 - g2);

...
--
-- Name: valid_spectral_types_enum; Type: TYPE; Schema: public; Owner: ec2-user
--

CREATE TYPE valid_spectral_types_enum AS ENUM (
    'O',
    'B',
    'A',
    'F',
...
ALTER TYPE public.valid_spectral_types_enum OWNER TO "ec2-user";
...
CREATE TABLE stars (
    ...
    spectral_type valid_spectral_types_enum NOT NULL,
...
SELECT pg_catalog.setval('stars_id_seq', 6, true);
